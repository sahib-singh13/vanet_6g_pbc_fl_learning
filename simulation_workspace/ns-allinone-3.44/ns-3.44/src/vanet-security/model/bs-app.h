...
private:
  ...
  void RequestCertFromTa(uint32_t nodeId,
  ...
  std::unordered_map<uint32_t, std::vector<uint8_t>> m_pid1Cache;
  std::unordered_map<uint32_t, std::vector<uint8_t>> m_pid2Cache;
  std::unordered_map<uint32_t, uint64_t> m_tiCache;
  std::unordered_map<uint32_t, std::vector<uint8_t>> m_siCache;
  ...
  std::unordered_map<uint32_t, Time> m_kgcSentAt;
  std::unordered_map<uint32_t, Time> m_taSentAt;
};
